...
parser.add_argument('--face_cascade', help='Path to face cascade.', default='cascade/cascade.xml')
parser.add_argument('--eyes_cascade', help='Path to eyes cascade.', default='D:/opencv-3.4/data/haarcascades/haarcascade_eye_tree_eyeglasses.xml')
