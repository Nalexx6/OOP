...
//auxiliary namespace to make contained within functions "private" for user
    ...
    std::vector<figures::Point> intersection(Line &line1, Line &line2) {
    ...
    std::vector<figures::Point> intersection(Line &line, Circle &circle) {
    ...
    std::vector<figures::Point> intersection(Circle &circle1, Circle &circle2) {
    ...
    figures::Line sym_display(Line &line, Line &to_sym) {
    ...
    figures::Circle sym_display(Line &line, Circle &to_sym) {
    ...
    figures::Circle inversion(Circle &circle, Line &to_invert) {
    ...
    figures::Line inversion_cross(Circle &circle, Circle &to_invert) {
    ...
    figures::Circle inversion(Circle &circle, Circle &to_invert) {
