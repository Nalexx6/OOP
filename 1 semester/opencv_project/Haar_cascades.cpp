...
void Haar_cascades::detectAndDisplay(cv::Mat frame) {
...
int Haar_cascades::run() {

//    cv::CommandLineParser parser(argc, argv,
//                                 "{help h||}"
//                                 "{face_cascade|/run/media/nalexx/data/opencv-3.4/data/haarcascades/haarcascade_frontalface_alt.xml|Path to face cascade.}"
//                                 "{eyes_cascade|/run/media/nalexx/data/opencv-3.4/data/haarcascades/haarcascade_eye_tree_eyeglasses.xml|Path to eyes cascade.}"
